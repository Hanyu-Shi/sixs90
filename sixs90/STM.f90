...
! - to vary the number of quadratures
    ...
    real(8) :: phr(20,nqdef_p),qhr(20,nqdef_p),uhr(20,nqdef_p)
! - to vary the number of quadratures
    real(8) :: ex,sc,asy,vi
    common /sixs_coef/ ex(4,20),sc(4,20),asy(4,20),vi(4)
    real(8) :: ex_m(20),sc_m(20),asy_m(20)
    integer :: i,j


! Stratospheric aerosol model
! The parameters and refractive indices for a one-year-old
! aerosol are taken from Russel et al., 'Global to microscale
! evolution of the Pinatubo volcanic aerosol derived from
! diverse measurements and analyses', Journal of Geophysical
! Research, 101(D13), pp. 18745-18763, 1996.
! Extinction coefficients are calculated in km-1

!*************** MIE (asy) ******************
    data (asy_m(j),j=1,20)/                                             &
       0.787,0.795,0.796,0.800,0.802,0.804,0.806,0.808,0.809,0.810,     &
       0.810,0.809,0.807,0.802,0.770,0.736,0.723,0.685,0.647,0.469/
!*************** MIE (ext&sca) ******************
        data (ex_m(j),sc_m(j),j=1,20) /                                 &
       0.1323426E+01,0.1323426E+01,0.1367378E+01,0.1367378E+01,         &
       0.1375664E+01,0.1375664E+01,0.1389866E+01,0.1389866E+01,         &
       0.1397082E+01,0.1397082E+01,0.1397282E+01,0.1397282E+01,         &
       0.1394358E+01,0.1394358E+01,0.1384032E+01,0.1384032E+01,         &
       0.1363314E+01,0.1363314E+01,0.1332585E+01,0.1332585E+01,         &
       0.1301248E+01,0.1301248E+01,0.1278673E+01,0.1278673E+01,         &
       0.1211386E+01,0.1211386E+01,0.1101411E+01,0.1101411E+01,         &
       0.7206790E+00,0.7206790E+00,0.5124845E+00,0.5124845E+00,         &
       0.4508164E+00,0.4508164E+00,0.3256089E+00,0.3256089E+00,         &
       0.2397076E+00,0.2397076E+00,0.6640586E-01,0.6640586E-01 /
!************** MIE (phase fun ph) ***************
