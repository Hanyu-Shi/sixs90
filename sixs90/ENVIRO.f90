subroutine enviro (difr,difa,r,palt,xmuv,fra,fae,fr)
    implicit none
    real(8) :: difr, difa, r, palt
    real(8) :: fae,fra,fr,fae0,fra0,xmuv,xlnv,a0,b0,a1,b1
    real(8) :: zmin,zmax,xcfr1,xcfr2,xcfa1,xcfa2,xcfa3
    real(8) :: alt(16),cfr1(16),cfr2(16),cfa1(16),cfa2(16),cfa3(16)
    integer :: i
