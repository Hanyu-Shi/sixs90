subroutine posgw(month,jday,tu,nc,nl,asol,phi0,avis,phiv,xlon,xlat)
    implicit none
    logical:: ier
    real(8) :: tu,asol,phi0,avis,phiv,xlon,xlat,yr,xr
    real(8) :: alti,re,aaa,rp,pi,cdr,crd,deltax,deltay
    real(8) :: x,y,rs,tanx,tany,val1,val2,yk,cosx2,sn
    real(8) :: zt,xt,yt,teta,ylat,ylon,gam
