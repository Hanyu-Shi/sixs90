...
! - to vary the number of quadratures
    ...
    real(8) :: ex_m(20),sc_m(20),asy_m(20),vi_m
    integer :: i,j
...
!*************** MIE (asy) ******************
    data (asy_m(j),j=1,20)/                                             &
       0.846,0.838,0.836,0.832,0.827,0.826,0.822,0.817,0.812,0.807,     &
       0.802,0.800,0.792,0.785,0.778,0.795,0.808,0.859,0.892,0.853/
!*************** MIE (ext&sca) ******************
    data (ex_m(j),sc_m(j),j=1,20) /                                     &
       0.8230388E+01,0.5565700E+01,0.8305723E+01,0.5744132E+01,         &
       0.8328883E+01,0.5786949E+01,0.8368396E+01,0.5888061E+01,         &
       0.8415968E+01,0.5976042E+01,0.8428650E+01,0.6028808E+01,         &
       0.8467864E+01,0.6112733E+01,0.8519962E+01,0.6215003E+01,         &
       0.8583242E+01,0.6333235E+01,0.8632867E+01,0.6450123E+01,         &
       0.8689027E+01,0.6547941E+01,0.8704309E+01,0.6603794E+01,         &
       0.8803438E+01,0.6771705E+01,0.8924636E+01,0.7002420E+01,         &
       0.9300344E+01,0.7719834E+01,0.9404915E+01,0.8043072E+01,         &
       0.9368683E+01,0.8084310E+01,0.8811917E+01,0.7738148E+01,         &
       0.7876924E+01,0.6921192E+01,0.7002555E+01,0.6187184E+01 /
!************** MIE (phase fun ph) ***************
