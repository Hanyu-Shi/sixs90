...
! constant : xdep: depolarization factor (0.0279)
    ...
    real(8) :: xdep,pl(10)
    real(8) :: fs0,fs1,fs2
    real(8) :: as0(10),as1(2),as2(2)
    real(8) :: xphi,xmus,fac,xmuv,xtau,xrray,pi,phios,xcosf1,xcosf2
    real(8) :: xcosf3,xbeta2,xfd,xph1,xph2,xph3,xitm, xp1, xp2, xp3
    real(8) :: cfonc1,cfonc2,cfonc3,xlntau,xitot1,xitot2,xitot3
    integer :: i
