...
!   total    absorption carbon mono ttmoca
    ...
    real(8) :: z,p,t,wh,wo
    real(8) :: zpl,ppl,tpl,whpl,wopl
    integer :: iv,ivli(6),idatm,idatmp,i,id,idgaz,inu,k,n,nh
    real(8) :: co3(102),tnu(10,3),a(8),rm(34),r2(34),r3(34),tp(34),rat(10)
    real(8) :: rmpl(34),r2pl(34),r3pl(34),ratpl(10)
    real(8) :: cch2o(15)
    real(8) :: wl,xmus,xmuv,uw,uo3,uwus,uo3us,uwpl,uo3pl,uwusp,uo3usp
    real(8) :: accu,ah2o,xh,dtcont,utcont,ttcont
    real(8) :: ptest1,ptest
    real(8) :: dtoxyg,dtniox,dtmeth,dtmoca,dtwava,dtozon,dtdica
    real(8) :: utniox,utdica,utoxyg,utwava,utozon
    real(8) :: utmeth,utmoca,ttwava,ttozon,ttdica,ttoxyg,ttniox,ttmeth
    real(8) :: ttmoca
    real(8) :: p0,g,t0,ds,te,roair,air,roco2,rmo2,rmo3,rmn2o,rmch4
    real(8) :: rmco,v,te2,phi,psi,uu,u,up,uud,uut,uuu
    real(8) :: ud,ut,upd,upt,udp,updp,udtp,updtp
    real(8) :: ds2,uupl,upl,uppl
    real(8) :: xi,xd,ako3,test1,test2,test3,udt,atest
    real(8) :: updt,tt,y,utt,uptt,tn
    ...
    DATA (CCH2O(I),I=1,15)/                                       &
    0.00,0.19,0.15,0.12,0.10,0.09,0.10,0.12,0.15,0.17,0.20,0.24, &
    0.28,0.33,0.00/
...
140 n=int(xi+1.001) ! xi+1.001 ! HyS
    xd=xi-float(n)
...
45  ptest1=tnu(1,1)*dtcont
    ...
    return
95  call print_error('Error on zenithal angle ( near 90 deg )')
    return
end
