...
! Parameters and refractive indices - AERONET measurements
! (see Example_In_1.txt in 'Examples')
! Extinction coefficients are calculated in km-1

!*************** MIE (asy) ******************
    data (asy_m(j),j=1,20)/                                             &
       0.709,0.689,0.684,0.671,0.659,0.651,0.639,0.623,0.605,0.586,     &
       0.570,0.560,0.534,0.500,0.455,0.493,0.515,0.573,0.619,0.698/
!************** MIE (ext&sca) ******************
    data (ex_m(j),sc_m(j),j=1,20) /                                     &
       0.8254323E-01,0.7805500E-01,0.6873854E-01,0.6486657E-01,         &
       0.6574472E-01,0.6199898E-01,0.5858313E-01,0.5513438E-01,         &
       0.5299549E-01,0.4977275E-01,0.4958472E-01,0.4650205E-01,         &
       0.4491529E-01,0.4202277E-01,0.3959285E-01,0.3691657E-01,         &
       0.3440313E-01,0.3194462E-01,0.2972500E-01,0.2746937E-01,         &
       0.2632282E-01,0.2421588E-01,0.2437306E-01,0.2235581E-01,         &
       0.1990872E-01,0.1810272E-01,0.1504618E-01,0.1349245E-01,         &
       0.6794238E-02,0.5778257E-02,0.4662405E-02,0.3859948E-02,         &
       0.4203070E-02,0.3459487E-02,0.3449567E-02,0.2823499E-02,         &
       0.3032236E-02,0.2492706E-02,0.2203834E-02,0.1881847E-02 /
!************** MIE (phase fun ph) ***************
