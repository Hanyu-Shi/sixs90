...
!****************************************************************************c
    ...
    real(8) :: rolut(mu_p,41),roluts(20,mu_p,41),roluti(mu_p,41)
    real(8) :: rolutq(mu_p,41),rolutsq(20,mu_p,41),rolutiq(mu_p,41)
    real(8) :: rolutu(mu_p,41),rolutsu(20,mu_p,41),rolutiu(mu_p,41)
    real(8) :: filut(mu_p,41)
    integer :: aerod
...
! variables used in the BRDF coupling correction process
    ...
    real(8) :: coefa,coefb,coefc,discri,rogbrdf
...
!***********************************************************************
    ...
    character(17) :: nsat(166)
    character(51) :: atmid(7)
    character(71) :: reflec(8)
...
!        31  1st band of mss(landsat5)( 0.475-0.640 )                  c
!        32  2nd      "               ( 0.580-0.750 )                  c
!        33  3rd      "               ( 0.655-0.855 )                  c
!        34  4th      "               ( 0.785-1.100 )                  c
...
!        80  MERIS   band 7           ( 0.664)                         c
!        81  MERIS   band 8           ( 0.681)                         c
!        82  MERIS   band 9           ( 0.708)                         c
!        83  MERIS   band 10          ( 0.753)                         c
!        84  MERIS   band 11          ( 0.760)                         c
!        85  MERIS   band 12          ( 0.778)                         c
!        86  MERIS   band 13          ( 0.865)                         c
!        87  MERIS   band 14          ( 0.885)                         c
!        88  MERIS   band 15          ( 0.900)                         c
!        89  GLI     band 1           (0.380-1km)                      c
!        90  GLI     band 2           (0.400-1km)                      c
!        91  GLI     band 3           (0.412-1km)                      c
!        92  GLI     band 4           (0.443-1km)                      c
...
!       119  ALI     band 1p          (0.4225-0.4625)                  c
!       120  ALI     band 1           (0.4325-0.550)                   c
!       121  ALI     band 2           (0.500-0.630)                    c
!       122  ALI     band 3           (0.5755-0.730)                   c
!       123  ALI     band 4           (0.7525-0.8375)                  c
!       124  ALI     band 4p          (0.8025-0.935)                   c
!       125  ALI     band 5p          (1.130-1.345)                    c
!       126  ALI     band 5           (1.470-1.820)                    c
!       127  ALI     band 7           (1.980-2.530)                    c
!       128  ASTER   band 1           (0.485-0.6425)                   c
!       129  ASTER   band 2           (0.590-0.730)                    c
!       130  ASTER   band 3n          (0.720-0.9075)                   c
!       131  ASTER   band 3b          (0.720-0.9225)                   c
!       132  ASTER   band 4           (1.570-1.7675)                   c
!       133  ASTER   band 5           (2.120-2.2825)                   c
!       134  ASTER   band 6           (2.150-2.295)                    c
!       135  ASTER   band 7           (2.210-2.390)                    c
!       136  ASTER   band 8           (2.250-2.440)                    c
!       137  ASTER   band 9           (2.2975-2.4875)                  c
!       138  ETM     band 1           (0.435-0.52) 		               c
!       139  ETM     band 2           (0.5-0.6225)                     c
!       140  ETM     band 3           (0.615-0.7025)                   c
!       141  ETM     band 4           (0.74-0.9125)                    c
!       142  ETM     band 5           (1.51-1.7875)                    c
!       143  ETM     band 7           (2.015-2.3775)                   c
!       144  HYPBLUE band 1           (0.4375-0.500)                   c
!       145  HYPBLUE band 2           (0.435-0.52)                     c
!       146  VGT     band 1           (0.4175-0.500)                   c
!       147  VGT     band 2           (0.5975-0.7675)                  c
!       148  VGT     band 3           (0.7325-0.9575)                  c
!       149  VGT     band 4           (1.5225-1.800)                   c
!       150  VIIRS   band M1          (0.4025-0.4225)                  c
!       151  VIIRS   band M2          (0.4350-0.4550)                  c
!       152  VIIRS   band M3          (0.4775-0.4975)                  c
!       153  VIIRS   band M4          (0.5450-0.5650)                  c
!       154  VIIRS   band M5          (0.6625-0.6825)                  c
!       155  VIIRS   band M6          (0.7375-0.7525)                  c
!       156  VIIRS   band M7          (0.8450-0.8850)                  c
!       157  VIIRS   band M8          (1.2300-1.2500)                  c
!       158  VIIRS   band M9          (1.3700-1.3850)                  c
!       159  VIIRS   band M10         (1.5800-1.6400)                  c
!       160  VIIRS   band M11         (2.2250-2.2750)                  c
!       161  VIIRS   band M12         (3.6100-3.7900)                  c
!       162  VIIRS   band I1          (0.6000-0.6800)                  c
!       163  VIIRS   band I2          (0.8450-0.8850)                  c
!       164  VIIRS   band I3          (1.5800-1.6400)                  c
!       165  VIIRS   band I4          (3.5500-3.9300)                  c
...
! --- ground reflectance (type and spectral variation) ----
 ...
 2000    write(iwr, 190)
         write(iwr, 187)rocave,robar1/xnorm1,robar2/xnorm2,albbrdf
         goto 2009
...
! solve equations, computer solutions
...
!**********************************************************************c
 ...
 1510 format(1h*,10x,a17,t79,1h*,/, &
  ...
  187 format(1h*,t79,1h*,/,                                           &
       ...
       1h*,15x,40h     rodir    robar    ropbar    albedo ,t79,1h*,/, &
             1h*,15x,4(f9.4,1x),t79,1h*)
